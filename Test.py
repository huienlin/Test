...
def stock_crawler(targets):
    ...
    start_time = datetime.datetime.strptime(str(time.date())+'16:30', '%Y-%m-%d%H:%M')
    end_time =  datetime.datetime.strptime(str(time.date())+'17:30', '%Y-%m-%d%H:%M')
